...
#         self.positionDetailAdd(positionDetailTempList, op)
    ...
    def incomeAttribution(self, fundName, startDate, endDate):
        ...
        for i in tradeHistoryRepoNotClosed:
            ...
            incomeAttr.accruedInterest = i.price * i.quantity * i.repoRate / 3600000
            ...
            if tradeHistory.quantity == 0:
                ...
                if s.reserve4 != 'Y':
                    incomeAttr.accruedInterest = tradeHistory.quantity * tradeHistory.coupon * currPriceHistory.factor \
                        * float(currFxHistory.rate) / 36000
                else:
    ...
    def incomeAttributionYTD(self):
        ...
        tradeCloseEqtyList = g.dataBase.qTradeCloseForIncomeAttr('EQTY', '2018-01-01')
        tradeCloseFutList = g.dataBase.qTradeCloseForIncomeAttr('FUT', '2018-01-01')
        tradeCloseCallList = g.dataBase.qTradeCloseForIncomeAttr('CALL', '2018-01-01')
        tradeClosePutList = g.dataBase.qTradeCloseForIncomeAttr('PUT', '2018-01-01')
        tradeCloseCDSList = g.dataBase.qTradeCloseForIncomeAttr('CDS', '2018-01-01')
        tradeCloseBondList = g.dataBase.qTradeCloseForIncomeAttr('EURO', '2018-01-01')
        tradeCloseRepoList = g.dataBase.qTradeCloseForIncomeAttr('CREPO', '2018-01-01')
    ...
    def incomeAttributionMTD(self):
        ...
        tradeCloseEqtyList = g.dataBase.qTradeCloseForIncomeAttr('EQTY', '2018-10-01')
        tradeCloseFutList = g.dataBase.qTradeCloseForIncomeAttr('FUT', '2018-10-01')
        tradeCloseCallList = g.dataBase.qTradeCloseForIncomeAttr('CALL', '2018-10-01')
        tradeClosePutList = g.dataBase.qTradeCloseForIncomeAttr('PUT', '2018-10-01')
        tradeCloseCDSList = g.dataBase.qTradeCloseForIncomeAttr('CDS', '2018-10-01')
        tradeCloseBondList = g.dataBase.qTradeCloseForIncomeAttr('EURO', '2018-10-01')
        tradeCloseRepoList = g.dataBase.qTradeCloseForIncomeAttr('CREPO', '2018-10-01')
    ...
    def tradeCloseForIncomeAttribution(self, incomeAttrDict, tradeCloseList, securityType):
        for tradeClose in tradeCloseList:
            if tradeClose.currType1 != 'USD':
                if tradeClose.tradeDate2 < datetime.date(2018, 1, 1):
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeClose.currType1, '2017-12-29')[0].rate)
                else:
            ...
            if securityType != 'BOND':
                ...
                if tradeClose.tradeDate2 < datetime.date(2018, 1, 1):
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, '2017-12-29')[0].factor)
                else:
            ...
            if tradeClose.tradeDate2 < datetime.date(2018, 1, 1):
                if securityType == 'REPO':
                    ...
                    price1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, '2017-12-29')[0].price)
            ...
            if tradeClose.ISIN not in incomeAttrDict:
                ...
                if tradeClose.side1 == 'S':
                    ...
                    if ia.securityType == 'CDS' or securityType == 'BOND':
                        ...
                        ia.accruedInterest = float(tradeClose.accruedInt1) * fx2
                        ia.total += float(tradeClose.accruedInt1) * fx2
                ...
                if securityType == 'REPO':
                    incomeAttrDict[tradeClose.ISIN].accruedInterest += float(tradeClose.accruedInt1) * fx2
                    incomeAttrDict[tradeClose.ISIN].total += float(tradeClose.accruedInt1) * fx2
    
    def tradeCloseForIncomeAttributionMTD(self, incomeAttrDict, tradeCloseList, securityType):
        for tradeClose in tradeCloseList:
            if tradeClose.currType1 != 'USD':
                if tradeClose.tradeDate2 < datetime.date(2018, 10, 1):
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeClose.currType1, '2018-9-28')[0].rate)
                else:
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeClose.currType1, tradeClose.tradeDate2)[0].rate)
                fx2 = float(g.dataBase.qCurrencyByDate(tradeClose.currType1, tradeClose.tradeDate1)[0].rate)
            else:
            ...
            if securityType != 'BOND':
                ...
                if tradeClose.tradeDate2 < datetime.date(2018, 10, 1):
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, '2018-9-28')[0].factor)
                else:
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, tradeClose.tradeDate2)[0].factor)
                factor2 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, tradeClose.tradeDate1)[0].factor)
            ...
            if tradeClose.tradeDate2 < datetime.date(2018, 10, 1):
                if securityType == 'REPO':
                    ...
                    price1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeClose.ISIN, '2018-9-28')[0].price)
                    if securityType == 'CDS' or securityType == 'BOND':
                        price1 = price1 / 100
            else:
                if securityType == 'FUT' or securityType == 'REPO' or securityType == 'CDS' or securityType == 'BOND':
    ...
    def tradeHistoryForIncomeAttribution(self, incomeAttrDict, tradeHistoryNotClosedList, securityType):
        ...
        for tradeHistory in tradeHistoryNotClosedList:
            ...
            if str(tradeHistory.currType) != 'USD':
                if tradeHistory.tradeDate < datetime.date(2018, 1, 1):
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeHistory.currType, '2017-12-29')[0].rate)
                else:
            ...
            if securityType != 'BOND':
                ...
                if tradeHistory.tradeDate < datetime.date(2018, 1, 1):
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeHistory.ISIN, '2017-12-29')[0].factor)
                else:
            ...
            if tradeHistory.tradeDate < datetime.date(2018, 1, 1):
                if securityType == 'REPO':
                    ...
                    price1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeHistory.ISIN, '2017-12-29')[0].price)
                    if securityType == 'CDS' or securityType == 'BOND':
                        price1 = price1 / 100
            else:
                if securityType == 'FUT' or securityType == 'REPO' or securityType == 'CDS' or securityType == 'BOND':
            ...
            if str(tradeHistory.ISIN) not in incomeAttrDict:
                ...
                if securityType == 'REPO':
                    ...
                    ia.total += self.intEarnedForRepoNotClosed(tradeHistory, price2, fx2)
                if ia.securityType == 'CDS' or securityType == 'BOND':
                    ia.accruedInterest = self.intEarnedForBondCdsNotClosed(tradeHistory, fx2)
                    ia.total += self.intEarnedForBondCdsNotClosed(tradeHistory, fx2)
                ...
                if securityType == 'REPO':
                    ...
                    incomeAttrDict[str(tradeHistory.ISIN)].total += self.intEarnedForRepoNotClosed(tradeHistory, price2, fx2)
                if securityType == 'CDS' or securityType == 'BOND':
    ...
    def tradeHistoryForIncomeAttributionMTD(self, incomeAttrDict, tradeHistoryNotClosedList, securityType):
        ...
        for tradeHistory in tradeHistoryNotClosedList:
            ...
            if str(tradeHistory.currType) != 'USD':
                if tradeHistory.tradeDate < datetime.date(2018, 10, 1):
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeHistory.currType, '2018-09-28')[0].rate)
                else:
                    fx1 = float(g.dataBase.qCurrencyByDate(tradeHistory.currType, tradeHistory.tradeDate)[0].rate)
                fx2 = float(g.dataBase.qLatestCurrency(tradeHistory.currType)[0].rate)
            else:
            ...
            if securityType != 'BOND':
                ...
                if tradeHistory.tradeDate < datetime.date(2018, 10, 1):
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeHistory.ISIN, '2018-09-28')[0].factor)
                else:
                    factor1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeHistory.ISIN, tradeHistory.tradeDate)[0].factor)
                factor2 = float(g.dataBase.qPriceHistoryByPriceDate(tradeHistory.ISIN, date.today())[0].factor)
            ...
            if tradeHistory.tradeDate < datetime.date(2018, 10, 1):
                if securityType == 'REPO':
                    ...
                    price1 = float(g.dataBase.qPriceHistoryAtPriceDate(tradeHistory.ISIN, '2018-09-28')[0].price)
                    if securityType == 'CDS' or securityType == 'BOND':
                        price1 = price1 / 100
            else:
                if securityType == 'FUT' or securityType == 'REPO' or securityType == 'CDS' or securityType == 'BOND':
    ...
    def intEarnedForRepoNotClosed(self, tradeHistory, price, fx):
        settleDate = max(tradeHistory.settleDate, datetime.date(2017, 12, 31))
        today = date.today()
    ...
    def intEarnedForRepoNotClosedMTD(self, tradeHistory, price, fx):
        settleDate = max(tradeHistory.settleDate, datetime.date(2018, 9, 30))
        today = date.today()
        if (today - settleDate).days > 0:
            interest = float(tradeHistory.reserve1) * price * float(tradeHistory.repoRate) * fx * (today - settleDate).days / 36000
        else:
        ...
        if tradeHistory.tranType == 'CDS':
            ...
            if str(securityInfo.reserve4) != 'Y':
                ...
                if expectedLastCoupDt > securityInfo.firstCoupDt:
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                if expectedLastCoupDt < max(tradeHistory.settleDate, datetime.date(2017, 12, 31)):
                    interest = 0
                else:
                    settleDate1 = max(tradeHistory.settleDate, datetime.date(2017, 12, 31))
        ...
        if tradeHistory.tranType == 'CDS':
            ...
            if str(securityInfo.reserve4) != 'Y':
                ...
                if expectedLastCoupDt > securityInfo.firstCoupDt:
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                if expectedLastCoupDt < max(tradeHistory.settleDate, datetime.date(2018, 9, 30)):
                    interest = 0
                else:
                    settleDate1 = max(tradeHistory.settleDate, datetime.date(2018, 9, 30))
                    settleDate2 = expectedLastCoupDt
                    interest = float(tradeHistory.reserve1) * float(tradeHistory.coupon) * fx * (settleDate2 - settleDate1).days \
                                * factor / 36000
        if tradeHistory.side == 'S':
    ...
    def intEarnedForBondCdsClosed(self, tradeClose):
        if tradeClose.tranType == 'CDS':
            settleDate1 = max(tradeClose.settleDate2, datetime.date(2017, 12, 31))
            ...
            if str(securityInfo.reserve4) != 'Y':
                ...
                if expectedLastCoupDt > securityInfo.firstCoupDt:
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                if expectedLastCoupDt < max(tradeClose.settleDate2, datetime.date(2017, 12, 31)):
                    interest = 0
                else:
                    settleDate1 = max(tradeClose.settleDate2, datetime.date(2017, 12, 31))
                    settleDate2 = expectedLastCoupDt
    ...
    def intEarnedForBondCdsClosedMTD(self, tradeClose):
        if tradeClose.tranType == 'CDS':
            settleDate1 = max(tradeClose.settleDate2, datetime.date(2018, 9, 30))
            settleDate2 = tradeClose.settleDate1
            interest = float(tradeClose.quantity1) * (float(tradeClose.coupon)/100) * float(tradeClose.fxRate1) \
                        * (settleDate2 - settleDate1).days / 360
        elif tradeClose.tranType == 'EURO':
            ...
            if str(securityInfo.reserve4) != 'Y':
                ...
                if expectedLastCoupDt > securityInfo.firstCoupDt:
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                    expectedLastCoupDt -= relativedelta(months = 12 / couponFreq)
                if expectedLastCoupDt < max(tradeClose.settleDate2, datetime.date(2018, 9, 30)):
                    interest = 0
                else:
                    settleDate1 = max(tradeClose.settleDate2, datetime.date(2018, 9, 30))
                    settleDate2 = expectedLastCoupDt
    ...
    def unRealizedDetails(self, unrzGlList, openPositions):
        bondDict = {}
        equityDict = {}
        futureDict = {}
        repoDict = {}
        ...
        for op in openPositions:
            ...
            tempDict['ordinaryIncome'] = 0
            tempDict['totalrlz'] = 0
            if tempUnrzGL.securityType == "BOND":
                bondDict['details'].append(tempDict)
    ...
    def bondPerformanceForRisk(self, openPositions, incomeAttrs):
        marketValueByCountryDict = {}
        incomeAttrByCountryDict = {}
        isinDict = {}
        bondConstituteList = []
        bondMarketValue = 0 
        bondPnl = 0
        ...
        for op in openPositions:
            if op['Category'] == 'BOND' or op['Category'] == 'BOND (defaulted)':
                isinDict[op['ISIN']] = True
                bondMarketValue += op['MarketValue']
                if op['Country'] not in marketValueByCountryDict:
                    marketValueByCountryDict[op['Country']] = {}
                    marketValueByCountryDict[op['Country']][current_app.config[op['ISIN']]] = op['MarketValue']
                else:
                    if current_app.config[op['ISIN']] not in marketValueByCountryDict[op['Country']]:
                        marketValueByCountryDict[op['Country']][current_app.config[op['ISIN']]] = op['MarketValue']
                    else:
                        marketValueByCountryDict[op['Country']][current_app.config[op['ISIN']]] += op['MarketValue']
        
        for ia in incomeAttrs:
            if ia['Type'] == 'BOND' or ia['Type'] == 'BOND (defaulted)':
                if ia['ISIN'] in isinDict:
                    bondPnl += ia['Total']
                    if ia['Country'] not in incomeAttrByCountryDict:
                        incomeAttrByCountryDict[ia['Country']] = {}
                        incomeAttrByCountryDict[ia['Country']][current_app.config[ia['ISIN']]] = ia['Total']
                    else:
                        if current_app.config[ia['ISIN']] not in incomeAttrByCountryDict[ia['Country']]:
                            incomeAttrByCountryDict[ia['Country']][current_app.config[ia['ISIN']]] = ia['Total']
                        else:
                            incomeAttrByCountryDict[ia['Country']][current_app.config[ia['ISIN']]] += ia['Total']
        ...
        def coloring(pnl):
            if pnl <= -1:
                ...
                return '#bf4045'
            elif pnl > -0.5 and pnl <= -0.05:
                return '#8b444e'
            elif pnl > -0.05 and pnl <= 0.05:
                return '#414554'
            elif pnl > 0.05 and pnl <= 0.5:
                return '#35764e'
        ...
        pnl = bondPnl * 100 / (bondMarketValue - bondPnl)
        tempDict = {'id' : '0.0', 'parent' : '', 'name' : 'BOND', 'Performance' : str(round(pnl, 2)) + '%', 'color' : coloring(pnl)}
        bondConstituteList.append(tempDict)
        count1 = 1.1
        count2 = 2.1
        for country, pnlDict in incomeAttrByCountryDict.items():
            tempPNL = 0
            tempMV = 0
            tempDict = {}
            tempDict['id'] = str(count1)
            tempDict['parent'] = '0.0'
            tempDict['name'] = current_app.config[country]
            tempCountryDict = marketValueByCountryDict[country]
            tempCountryMV = 0
            tempCountryPNL = 0
            for _, value in tempCountryDict.items():
                tempCountryMV += value
                
            for key, value in pnlDict.items():
                tempDict2 = {}
                tempDict2['id'] = str(count2)
                tempDict2['parent'] = str(count1)
                tempDict2['name'] = key
                tempDict2['value'] = abs(marketValueByCountryDict[country][key])
                pnl2 = value * 100 / abs(marketValueByCountryDict[country][key] - value)
                tempDict2['color'] = coloring(pnl2)
                tempDict2['Performance'] = str(round(pnl2, 2)) + '%'
                count2 += 0.1
                tempCountryPNL += value
                bondConstituteList.append(tempDict2)
            tempDict['color'] = coloring(tempCountryPNL * 100 / abs(tempCountryMV - tempCountryPNL))
            tempDict['Performance'] = str(round(tempCountryPNL * 100 / abs(tempCountryMV - tempCountryPNL), 2)) + '%'
            bondConstituteList.append(tempDict)
            count1 += 0.1
            
        return bondConstituteList
    
    def eqtyPerformanceForRisk(self, openPositions, incomeAttrs):
        marketValueByCategoryDict = {}
        incomeAttrByCategoryDict = {}
        isinDict = {}
        eqtyConstituteList = []
        eqtyMarketValue = 0 
        eqtyPnl = 0
        ...
        for op in openPositions:
            if op['Category'] == 'EQTY':
                isinDict[op['ISIN']] = True
                eqtyMarketValue += op['MarketValue']
                category = current_app.config[op['ISIN']]
                if category not in marketValueByCategoryDict:
                    marketValueByCategoryDict[category] = {}
                    marketValueByCategoryDict[category][op['Issuer']] = op['MarketValue']
                else:
                    if op['Issuer'] not in marketValueByCategoryDict[category]:
                        marketValueByCategoryDict[category][op['Issuer']] = op['MarketValue']
                    else:
                        marketValueByCategoryDict[category][op['Issuer']] += op['MarketValue']
        ...
        for ia in incomeAttrs:
            if ia['Type'] == 'EQTY':
                if ia['ISIN'] in isinDict:
                    eqtyPnl += ia['Total']
                    category = current_app.config[ia['ISIN']]
                    if category not in incomeAttrByCategoryDict:
                        incomeAttrByCategoryDict[category] = {}
                        incomeAttrByCategoryDict[category][ia['SecurityName']] = ia['Total']
                    else:
                        if ia['SecurityName'] not in incomeAttrByCategoryDict[category]:
                            incomeAttrByCategoryDict[category][ia['SecurityName']] = ia['Total']
                        else:
                            incomeAttrByCategoryDict[category][ia['SecurityName']] += ia['Total']
        ...
        pnl = eqtyPnl * 100 / (eqtyMarketValue - eqtyPnl)
        tempDict = {'id' : '0.0', 'parent' : '', 'name' : 'EQUITY', 'Performance' : str(round(pnl, 2)) + '%', 'color' : coloring(pnl)}
        eqtyConstituteList.append(tempDict)
        count1 = 1.1
        count2 = 2.1
        for category, pnlDict in incomeAttrByCategoryDict.items():
            tempPNL = 0
            tempMV = 0
            tempDict = {}
            tempDict['id'] = str(count1)
            ...
            tempCategoryDict = marketValueByCategoryDict[category]
            tempCategoryMV = 0
            tempCategoryPNL = 0
            for _, value in tempCategoryDict.items():
                tempCategoryMV += value
            ...
            for key, value in pnlDict.items():
                ...
                tempDict2['parent'] = str(count1)
                tempDict2['name'] = key
                tempDict2['value'] = abs(marketValueByCategoryDict[category][key])
                pnl2 = value * 100 / abs(marketValueByCategoryDict[category][key] - value)
                tempDict2['color'] = coloring(pnl2)
                tempDict2['Performance'] = str(round(pnl2, 2)) + '%'
                count2 += 0.1
                tempCategoryPNL += value
                eqtyConstituteList.append(tempDict2)
            tempDict['color'] = coloring(tempCategoryPNL * 100 / abs(tempCategoryMV - tempCategoryPNL))
            tempDict['Performance'] = str(round(tempCategoryPNL * 100 / abs(tempCategoryMV - tempCategoryPNL), 2)) + '%'
            eqtyConstituteList.append(tempDict)
            count1 += 0.1
            
        return eqtyConstituteList
